...
export async function run({ interaction }: SlashCommandProps) {
  const embed = new EmbedBuilder()
    ...
    .setColor("#eade58")
    .setThumbnail(
      "https://static.wikia.nocookie.net/onepiece/images/1/14/Carrot_Portrait.png/revision/latest"
    )
    .setImage(
      "https://preview.redd.it/a464085si0011.jpg?auto=webp&s=32fbc0f8d705c83d86de2a210b77b2242862d94c"
    );
